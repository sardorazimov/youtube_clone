...
const dummyVideos: Video[] = [
  {
    ...
    videoUrl: 'https://i.ytimg.com/vi/_SEPHLvqDjs/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AH-CYAC0AWKAgwIABABGGUgWChIMA8=&rs=AOn4CLCAcJSibyNz2Vy_vKvrHuOwc3XTzA',
    likes: 5000,
    dislikes: 50,
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen ">
      ...
      <main className="flex-1 flex flex-col md:flex-row">
            ...
            <div className="mb-4">
              <div className="aspect-w-16 aspect-h-9 mb-4">
                {selectedVideo.videoUrl ? (
                  <video src={'/poralab.mp4'} muted autoPlay controls className="w-full h-full rounded-lg" />
                ) : (
                  <img
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p onClick={() => router.push('/channels')} className="text-gray-600" >{selectedVideo.channel}</p>
              ...
              <div className="mb-4 overflow-auto">
                ...
                <div className="flex items-start space-x-2 mb-4">
                  <Avatar>
                    <AvatarImage src="/lena.jpeg" alt="Current User" />
        ...
        <aside className="w-full  md:w-80 p-4 border border-white/10">
