...
const Sidebar = () => {
  ...
  return (
    <section className=" fixed  -mt-10 overflow-auto overflow-y-scroll flex h-screen w-fit flex-col  justify-between border border-white/10 p-6 text-white max-sm:hidden lg:w-[264px]">
